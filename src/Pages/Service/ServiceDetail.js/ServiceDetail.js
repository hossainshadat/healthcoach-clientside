...
const ServiceDetail = () => {
  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="px-4 my-16 mx-auto flex flex-col  p-6 space-y-6 overflow-hidden rounded-lg  shadow-md bg-green-300 text-black-100">
        ...
        <div>
          <img
            src={img}
            alt=""
            className="object-cover w-full mb-4 h-60 sm:h-96 dark:dark:bg-gray-500"
          />
          <h2 className="mb-1 text-xl font-semibold">{title}</h2>
          <p className="text-sm dark:dark:text-gray-400">{description}</p>
        </div>
        <div className="flex flex-wrap justify-between">
      ...
      <ServiceReviewForm handleReview={handleReview} />
